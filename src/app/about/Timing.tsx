import { fetchAboutTimingImages } from '@/lib/actions'
import React from 'react'

const Timing = async () => {
    const timingImagesData = await fetchAboutTimingImages();
    ...
    return (
        ...
        >
            <div className="col-span-1 max-md:col-span-full md:h-[45vw] relative h-[45vh]  hero 
            bg-[url('/static/aboutTiming1.jpg')]"
                style={{ backgroundImage: `url(${timingImagesData[0].image})` }}
            >
            ...
            <div className="col-span-2  max-md:hidden h-[45vh] md:h-[45vw] relative hero bg-[url('/static/aboutTiming2.jpg')]"
                style={{ backgroundImage: `url(${timingImagesData[1].image})` }}
