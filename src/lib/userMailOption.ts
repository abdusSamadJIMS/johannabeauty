export default function optionGenerator({ userMail, userName }: { userMail: string, userName: string }) {
    const mailOptions = {
														...
														<tr>
															<td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
																<div class="alignment" align="center" style="line-height:10px">
																	<div style="max-width: 136px;"><img src="https://johannabeautysalon.in/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FlogoJohanna.bbfc71c9.png&w=640&q=75" style="display: block; height: auto; border: 0; width: 100%;" width="136" alt="Yourlogo Light" title="Yourlogo Light" height="auto"></div>
																</div>
															</td>
														</tr>
													</table>
													...
													<table class="image_block block-1" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="width:100%;">
																<div class="alignment" align="center" style="line-height:10px">
																	<div class="fullWidth" style="max-width: 340px;"><img src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/4966/cover-img-0.png" style="display: block; height: auto; border: 0; width: 100%;" width="340" alt="Cover image 01" title="Cover image 01" height="auto"></div>
																</div>
															</td>
														</tr>
													</table>
												...
												<td class="column column-2" width="50%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; background-color: #cbdbef; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
														...
														<tr>
															<td class="pad" style="padding-bottom:25px;padding-left:20px;padding-right:20px;padding-top:10px;">
																<div style="color:#2f2f2f;font-family:Georgia,Times,'Times New Roman',serif;font-size:34px;line-height:120%;text-align:center;mso-line-height-alt:40.8px;">
																	<p style="margin: 0; word-break: break-word;"><span>Your Query</span></p>
																	<p style="margin: 0; word-break: break-word;"><span>has been received !</span></p>
																</div>
															</td>
														</tr>
													</table>
													...
													<table class="image_block block-5" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="width:100%;">
																<div class="alignment" align="center" style="line-height:10px">
																	<div style="max-width: 340px;"><img src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/4966/cover-img-002.png" style="display: block; height: auto; border: 0; width: 100%;" width="340" alt="Cover image 02" title="Cover image 02" height="auto"></div>
																</div>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad" style="padding-bottom:10px;padding-left:30px;padding-right:30px;padding-top:10px;">
																<div style="color:#393d47;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:16px;line-height:150%;text-align:left;mso-line-height-alt:24px;">
																	<p style="margin: 0; word-break: break-word;"><span>Hi <u><strong>${userName}</strong></u>,</span></p>
																	<p style="margin: 0; word-break: break-word;"><strong>Thanks for showing your interest in JOHANNA BEAUTY SALON</strong></p>
																	<p style="margin: 0; word-break: break-word;">Your query has been reached to us successfully and we will contact you shortly</p>
																</div>
															</td>
														</tr>
													</table>
												...
												<td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 5px; padding-top: 5px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
													...
													<table class="image_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
																<div class="alignment" align="center" style="line-height:10px">
																	<div style="max-width: 204px;"><a href="https://johannabeautysalon.in" target="_blank" style="outline:none" tabindex="-1"><img src="https://johannabeautysalon.in/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FlogoJohanna.bbfc71c9.png&w=640&q=75" style="display: block; height: auto; border: 0; width: 100%;" width="204" alt="Yourlogo Light" title="Yourlogo Light" height="auto"></a></div>
																</div>
															</td>
														</tr>
													</table>
															...
															<td class="pad">
																<div class="alignment" align="center">
																	<table class="social-table" width="36px" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; display: inline-block;">
																		<tr>
																			<td style="padding:0 2px 0 2px;"><a href="https://www.instagram.com/johannabyswean/?igsh=MTBrNDQyYnpjYnZxdg%3D%3D" target="_blank"><img src="https://app-rsrc.getbee.io/public/resources/social-networks-icon-sets/t-circle-white/instagram@2x.png" width="32" height="auto" alt="Instagram" title="Instagram" style="display: block; height: auto; border: 0;"></a></td>
																		</tr>
																	</table>
																</div>
															</td>
														...
														<tr>
															<td class="pad">
																<div style="color:#f9f9f9;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:12px;line-height:150%;text-align:center;mso-line-height-alt:18px;">
																	<p id="contact-us" style="margin: 0;"></p>
																	<p style="margin: 0;">&nbsp;</p>
																	<p style="margin: 0;">&nbsp;</p>
																	<p style="margin: 0; word-break: break-word;">10/45, Block 10,</p>
																	<p style="margin: 0; word-break: break-word;">Geeta Colony, New Delhi,</p>
																	<p style="margin: 0; word-break: break-word;">Delhi, 110031</p>
																</div>
															</td>
														</tr>
													</table>
